...
<section class="category">
    ...
    <div class="box-container">
        ...
        <a href="<?= site_url('administrator/category/elektronik') ?>" class="box">
            <img src="<?php echo base_url() ?>assets/images/lenovo-yoga.png" alt="">
            <h3>Elektronik</h3>
        </a>

        <a href="<?= site_url('administrator/category/software') ?>" class="box">
            <img src="<?php echo base_url() ?>assets/images/software.png" alt="">
            <h3>Product Software</h3>
        </a>

        <a href="<?= site_url('administrator/category/aksesoris') ?>" class="box">
            <img src="<?php echo base_url() ?>assets/images/pin-1.png" alt="">
            <h3>Aksesoris</h3>
        </a>

        <a href="<?= site_url('administrator/category/alat_kantor') ?>" class="box">
            <img src="<?php echo base_url() ?>assets/images/hp-deskjet-1.png" alt="">
            <h3>Alat Tulis Kantor</h3>
        </a>

        <a href="<?= site_url('administrator/category/pakaian') ?>" class="box">
            <img src="<?php echo base_url() ?>assets/images/kaos-1.png" alt="">
            <h3>Pakaian</h3>
        </a>

        <a href="<?= site_url('administrator/category/jam_tangan') ?>" class="box">
