            ...
            <div class="box">
                ...
                <div class="box-header">
                    ...
                    <div class="pull-right">
                        <a href="<?= site_url('administrator/product') ?>" class="btn btn-warning btn-flat mb-3" style="float: right;"><i class="fa fa-undo"></i> Kembali </a>
                    </div>
                </div>
                ...
                <div class="box-body mt-5">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4" style="display:block; margin:auto;">
                            <form action="<?= site_url('administrator/product/process') ?>" method="post" enctype="multipart/form-data">
