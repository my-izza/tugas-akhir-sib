        ...
        <div class="card-header">
            ...
            <div class="box">
                ...
                <div class="box-header">
                    <h3 class="box-title"><?= ucfirst($page) ?> Promo </h3>
                    <div class="pull-right">
                        <a href="<?= site_url('administrator/promo') ?>" class="btn btn-warning btn-flat mb-3" style="float: right;"><i class="fa fa-undo"></i> Kembali </a>
                    </div>
                </div>
                ...
                <div class="box-body mt-5">
                    <div class="row">
                        <div class="col-md-4 col-md-offset-4" style="display:block; margin:auto;">
                            <form action="<?= site_url('administrator/promo/process') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="detail" id="" cols="30" rows="10" required> <?= $row->detail ?></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="category" class="form-control" id="" required>
                                        ...
                                        <option value="Elekronik">Elektronik</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="diskon" class="form-control" value="<?= $row->diskon ?>" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if ($page == 'edit') {
                                        if ($row->image != null) { ?>
                                            <div>
                                                <img src="<?= base_url() . '/uploads/newpromo/' . $row->image ?>" style="width: 50%px;" alt="">
                                            </div>
                                    <?php }
                                    } ?>
                                </div>
